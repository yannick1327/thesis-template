...
\begin{quote}
\emph{Welche der 6R-Strategien ist für die verschiedenen Komponenten von \texttt{frag.jetzt} jeweils am besten geeignet?}
\end{quote}
% das hier nochmal überdenken für die wirkliche BA Arbeit
Ziel der Arbeit ist eine nachvollziehbare und begründete Zuordnung einer Strategie \emph{pro Komponente}.
Die Begründung erfolgt anhand eines Kriterienkatalogs, der sowohl technische als auch organisatorische Aspekte berücksichtigt, insbesondere Wartbarkeit,
Sicherheitsanforderungen, Integrationsaufwand, Performance, Betriebskosten und erwartete Weiterentwicklung. 
...
(1) theoretische Fundierung der Migrationsstragtegien und Software-Modernisierung anhand relevanter Qualitätsattribute,
(2) Beschreibung des Systemkontexts und der betrachteten Komponenten von frag.jetzt, 
(3) methodisches Vorgehen zur Bewertung und Auswahl der Strategien für die jeweilige Komponente,
(4) Ergebnisdarstellung als begründete Zuordnung je Komponente inklusive Umsetzungsfahrplan und Reflexion der Grenzen.
